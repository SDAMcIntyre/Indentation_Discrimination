...
coord = coordinator.Coordinator(total=5,horizontal=3,vertical=1)
# create total of random sequences, Standard area, Comparison area
coord.create_left_right_random_sequences(10,'A','B')
...
# nRepeats = exptSettings['06. Number of repeats (even)'] / 2
